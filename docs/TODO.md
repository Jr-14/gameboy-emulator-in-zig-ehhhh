...
- [ ] Read [Emulating The Core, Part 3: Interrupt Processing](https://realboyemulator.wordpress.com/2013/07/01/interrupt-processing-a-real-world-example/)

# DONE

- [x] Read [Decimal Adjust Accumulator](https://blog.ollien.com/posts/gb-daa/)
