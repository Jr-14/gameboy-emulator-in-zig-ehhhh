...
test "decode and execute 0x01 [LD BC, d16]" {
    ...
    memory.write(PC, op_code);
    memory.write(PC + 1, lo);
    memory.write(PC + 2, hi);
    ...
    try expectEqual(PC + 3, processor.PC);
    try expectEqual(0x00, processor.A.value);
    try expectEqual(0x0000, processor.F.value);
    try expectEqual(hi, processor.B.value);
    try expectEqual(lo, processor.C.value);
    try expectEqual(utils.fromTwoBytes(lo, hi), processor.getBC());
    try expectEqual(0x00, processor.D.value);
    try expectEqual(0x00, processor.E.value);
    try expectEqual(0x00, processor.H.value);
    try expectEqual(0x00, processor.L.value);
}
...
test "decode and execute 0x02 [LD (BC), A]" {
    ...
    const B: u8 = rand.int(u8);
    const C: u8 = rand.int(u8);
    ...
    try expectEqual(0x00, processor.SP);
    try expectEqual(A, processor.A.value);
    try expectEqual(F, processor.F.value);
    try expectEqual(B, processor.B.value);
    try expectEqual(C, processor.C.value);
    try expectEqual(utils.fromTwoBytes(C, B), processor.getBC());
    try expectEqual(0x00, processor.D.value);
    try expectEqual(0x00, processor.E.value);
    try expectEqual(0x00, processor.H.value);
    try expectEqual(0x00, processor.L.value);
    try expectEqual(A, processor.memory.read(processor.getBC()));
}
...
// }
//
// test "decode and execute 0x05 [DEC B], HC" {
//     const op_code: u8 = 0x05;
//     const initial_PC: u16 = 0x0100;
//     const B: u8 = 0x00;
//     
...
//     try expectEqual(true, processor.isFlagSet(.H));
//     try expectEqual(false, processor.isFlagSet(.C));
//     try expectEqual(0xFF, processor.BC.getHi());
//     try expectEqual(0x00, processor.BC.getLo());
//     try expectEqual(0x00, processor.DE.get());
//     try expectEqual(0x00, processor.HL.get());
// }
//
// test "decode and execute 0x0C [INC C]" {
//     const op_code: u8 = 0x0C;
//     const initial_PC: u16 = 0x0100;
//
//     var memory: Memory = .init();
//     var processor: Processor = .init(&memory);
...
//     const instruction = processor.fetch();
//     try processor.decodeAndExecute(instruction);
//     try expectEqual(1, processor.BC.getLo());
//     try expectEqual(false, processor.isFlagSet(.Z));
//     try expectEqual(false, processor.isFlagSet(.N));
//     try expectEqual(false, processor.isFlagSet(.C));
// }
//
// test "decode and execute 0x0C [INC C], Z" {
//     const op_code: u8 = 0x0C;
//     const initial_PC: u16 = 0x0100;
//     const C: u8 = 0xFF;
//
...
// }
//
// test "decode and execute 0x0C [INC C], HC" {
//     const op_code: u8 = 0x0C;
//     const initial_PC: u16 = 0x0100;
//     const C: u8 = 0x1F;
//
...
//     const instruction = processor.fetch();
//     try processor.decodeAndExecute(instruction);
//     try expectEqual(0x20, processor.BC.getLo());
//     try expectEqual(false, processor.isFlagSet(.Z));
//     try expectEqual(false, processor.isFlagSet(.N));
//     try expectEqual(true, processor.isFlagSet(.H));
// }
...
// }
//
// test "decode and execute 0xD8 [RET C], C" {
...
// }
//
// test "decode and execute 0xD8 [RET C], NC" {
//     const op_code: u8 = 0xD8;
//     const initial_PC: u16 = 0x0100;
//     const SP: u16 = 0x0AFF;
//     const hi: u8 = rand.int(u8);
...
// }
//
// test "decode and execute 0xD9 [RETI]" {
//     const op_code: u8 = 0xD9;
//     const initial_PC: u16 = 0x0100;
//     const SP: u16 = 0x0AFF;
//     const hi = rand.int(u8);
//     const lo = rand.int(u8);
...
// }
//
// test "decode and execute 0xDA [JP C, a16], C" {
//     const op_code: u8 = 0xDA;
//     const initial_PC: u16 = 0x0100;
//     const hi = rand.int(u8);
//     const lo = rand.int(u8);
//
...
// }
//
// test "decode and execute 0xDA [JP C, a16], NC" {
//     const op_code: u8 = 0xDA;
//     const initial_PC: u16 = 0x0100;
//     const hi = rand.int(u8);
//     const lo = rand.int(u8);
...
// }
//
// test "decode and execute 0xDC [CALL C, a16], C" {
//     const op_code: u8 = 0xDC;
//     const initial_PC: u16 = 0x0100;
//     const SP: u16 = 0x0AFF;
//     const hi = rand.int(u8);
//     const lo = rand.int(u8);
...
// }
//
// test "decode and execute 0xDC [CALL C, a16], NC" {
//     const op_code: u8 = 0xDC;
//     const initial_PC: u16 = 0x0100;
//     const SP: u16 = 0x0AFF;
//     const hi = rand.int(u8);
...
// }
//
// test "decode and execute 0xFF [RST 7]" {
//     const op_code: u8 = 0xFF;
//     const initial_PC: u16 = 0x0100;
//     const SP: u16 = 0x0AFF;
//
//     var memory: Memory = .init();
...
//     const instruction = processor.fetch();
//     try processor.decodeAndExecute(instruction);
//     try expectEqual(0x0038, processor.PC.get());
//     try expectEqual(SP - 2, processor.SP.get());
//     try expectEqual(utils.getHiByte(initial_PC + 1), processor.memory.read(SP - 1));
//     try expectEqual(utils.getLoByte(initial_PC + 1), processor.memory.read(SP - 2));
//     try expectEqual(0x00, processor.AF.get());
