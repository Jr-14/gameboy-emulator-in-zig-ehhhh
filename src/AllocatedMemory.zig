...
pub const MAX_ADDRESSABLE_MEMORY: u16 = 0xFFFF;

// 65,536 positions inlcuding 0x00 and 0xffff
pub const ARRAY_SIZE: u32 = MAX_ADDRESSABLE_MEMORY + 1;
...
pub fn readByte(gameboy: *GameboyState, address: u16) !u8 {
    if (address > MAX_ADDRESSABLE_MEMORY) {
        @panic("Given address " ++ address ++ " is greater than the max addressable memory of " ++ MAX_ADDRESSABLE_MEMORY);
    }
